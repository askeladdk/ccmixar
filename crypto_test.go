...
func Test_blowfishKeyFromSource(t *testing.T) {
	key_source := []byte{
	...
	bfkey := blowfishKeyFromKeySource(key_source)
	if bytes.Compare(bfkey, expected_blowfish_key) != 0 {
